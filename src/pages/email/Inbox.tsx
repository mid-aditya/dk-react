...
const Email: React.FC = () => {
  const [view, setView] = useState<
    "inbox" | "detail" | "compose" | "reply" | "forward"
  >("inbox");
  const [selectedEmail, setSelectedEmail] = useState<Email | null>(null);
  const [currentPage, setCurrentPage] = useState(1);
  const [searchQuery, setSearchQuery] = useState("");
  const [activeDetailTab, setActiveDetailTab] = useState("user-journeys");
  const emailsPerPage = 5; // Reduced to show pagination with sample data
  ...
  const emails: Email[] = [
    ...
    },
    {
      ...
      preview: "I have prepared a new marketing strategy document for review.",
      attachments: 1,
      date: "16 Oct",
    },
    {
      ...
      preview: "Please find attached the revised budget for the next quarter.",
      attachments: 2,
      date: "15 Oct",
    },
    {
      ...
      preview: "Here is the weekly report for your review.",
      attachments: 1,
      date: "14 Oct",
    },
    {
      ...
      preview: "I wanted to update you on the progress of the project.",
      attachments: 2,
      date: "14 Oct",
    },
    {
      ...
      preview: "Please find the meeting notes from yesterday attached.",
      attachments: 1,
      date: "13 Oct",
    },
    {
      ...
      preview: "The budget has been approved and we can proceed.",
      attachments: 1,
      date: "13 Oct",
    },
  ];
