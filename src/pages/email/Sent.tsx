...
const Sent: React.FC = () => {
  const [view, setView] = useState<
    "sent" | "detail" | "compose" | "reply" | "forward"
  >("sent");
  ...
  const emails: Email[] = [
    {
      ...
      preview:
        "Thank you for contacting us regarding your Internet Banking issue...",
      attachments: 1,
      date: "19 Oct",
    },
    {
    ...
    },
    {
      ...
      preview: "I am requesting approval for the quarterly budget...",
      attachments: 1,
      date: "17 Oct",
    },
    {
    ...
    },
    {
      ...
      preview: "Please find the invoice for the services provided...",
      attachments: 1,
      date: "15 Oct",
    },
    {
      ...
      preview: "I wanted to follow up on my previous email regarding...",
      attachments: 0,
      date: "14 Oct",
    },
    {
      ...
      preview: "I am excited to announce the launch of our new product...",
      attachments: 3,
      date: "14 Oct",
    },
    {
      ...
      preview: "Please find attached the training schedule for next month...",
      attachments: 1,
      date: "13 Oct",
    },
    {
      ...
      preview: "I have reviewed the contract and would like to discuss...",
      attachments: 2,
      date: "13 Oct",
    },
  ];
  ...
  const handleReply = () => {
    if (selectedEmail) {
      setView("reply");
      setComposeData({
        to: selectedEmail.recipient.email,
        cc: "",
        bcc: "",
                ...
                <div className="mb-6 pb-6 border-b border-[var(--border-color)]">
                  <div className="flex items-start gap-4 mb-4">
                    <div className="w-14 h-14 rounded-full flex items-center justify-center bg-[var(--bg-tertiary)] text-[var(--text-primary)] font-semibold text-xl flex-shrink-0 border-2 border-[var(--border-color)]">
                      {selectedEmail?.recipient.avatar ? (
                        <img
                          src={selectedEmail.recipient.avatar}
                          alt={selectedEmail.recipient.name}
                          className="w-full h-full rounded-full object-cover"
                        />
                      ) : (
                        <span>
                          {selectedEmail?.recipient.name.charAt(0)}
                        </span>
                      )}
                    </div>
                    <div className="flex-1 min-w-0 flex flex-col gap-1">
                      <div className="font-semibold text-[var(--text-primary)] text-base leading-snug">
                        To: {selectedEmail?.recipient.name}
                      </div>
            ...
            <div className="w-[360px] flex-shrink-0 bg-[var(--bg-secondary)] border-l border-[var(--border-color)] flex flex-col overflow-hidden min-w-0">
              ...
              <div className="flex-1 overflow-y-auto p-4">
                ...
                {activeDetailTab === "overview" && (
                  <Overview user={selectedEmail?.recipient} />
                )}
