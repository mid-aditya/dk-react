...
const SubCategory: React.FC = () => {
  ...
  const [subCategories, setSubCategories] = useState<SubCategoryItem[]>([
    {
      id: 19,
      category: "Category 2",
      name: "Category Type 2 1",
      status: "active",
    },
    {
      id: 18,
      category: "Category 1",
      name: "Category Type 1 2",
      status: "active",
    },
    {
      id: 17,
      category: "Category 1",
      name: "Category Type 1 1",
      status: "active",
    },
  ]);
  ...
  const handleSubmit = () => {
    if (!formData.category.trim() || !formData.name.trim()) {
      alert("Kategori dan Nama Sub Kategori harus diisi");
      return;
    }
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-[var(--text-secondary)] m-0">
                Manage ticket sub category configurations
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-[var(--bg-secondary)] rounded-2xl p-6">
              ...
              {filteredSubCategories.length > 0 ? (
                ...
                <div className="flex flex-col items-center gap-2 py-12">
                  <FolderTree className="w-12 h-12 text-[var(--text-tertiary)]" />
