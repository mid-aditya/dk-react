...
const Category: React.FC = () => {
  ...
  const [categories, setCategories] = useState<CategoryItem[]>([
    {
      id: 3,
      nama_kategori: "Inquiry",
      deskripsi: "kategori inquiry",
      createdAt: "29 Juli 2025 pukul 03.20.43",
    },
    {
      id: 4,
      nama_kategori: "Request",
      deskripsi: "kategori request",
      createdAt: "29 Juli 2025 pukul 03.20.44",
    },
    {
      id: 5,
      nama_kategori: "Complaint",
      deskripsi: "kategori complaint",
      createdAt: "29 Juli 2025 pukul 03.20.44",
    },
  ]);
  ...
  const tableColumns: TableColumn<CategoryItem>[] = [
    ...
    },
    {
      ...
      align: "left",
      render: (item) => (
        <span className="text-[var(--text-primary)] font-medium">{item.nama_kategori}</span>
      ),
    },
    {
      key: "deskripsi",
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-[var(--text-secondary)] m-0">
                Manage categories for ticket forms
              </p>
            </div>
          </div>
        </div>
