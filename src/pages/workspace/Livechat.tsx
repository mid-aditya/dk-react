  ...
  const timelineTickets: JourneyStep[] = [
    {
      ...
      iconType: 'image',
      isCompleted: true,
      tooltip: 'WhatsApp Ticket - Oct 19, 2025'
    },
    {
      id: 'ticket2',
      label: '#JKT-9374-3U129',
      icon: '/assets/icons/whatsapp-business.svg',
      iconType: 'image',
      isCompleted: true,
      tooltip: 'WhatsApp Business Ticket - Oct 20, 2025'
    },
    {
      id: 'ticket3',
      ...
      iconType: 'image',
      isActive: true,
      tooltip: 'Telegram Ticket - Oct 21, 2025 (Current)'
    },
  ];
    ...
    <WorkspaceLayout>
      <div className="w-full h-full p-0 m-0 flex gap-0 overflow-hidden bg-[var(--bg-primary)] min-w-0 box-border relative">
        ...
        <div className="flex flex-col overflow-hidden min-w-0 bg-[var(--bg-secondary)] border-r border-[var(--border-color)] h-full relative flex-1 min-w-[400px] last:border-r-0">
          <div className="p-3 px-4 border-b border-[var(--border-color)] bg-[var(--bg-secondary)] flex items-center gap-3 flex-shrink-0">
